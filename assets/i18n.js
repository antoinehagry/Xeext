...
window.XEEXT_I18N = {
  ...
  en: {
    ...
    "fiche.applyCta": "Submit my application",
    ...
    "compte.tab.dossier": "My file",
    "compte.tab.profil": "Profile",
    "compte.loading": "Loading…",
    "compte.dossier.intro": "Save your documents once — they’ll be attached automatically to your applications, so you never upload them twice.",
    "compte.dossier.add": "Add",
    "compte.dossier.replace": "Replace",
    "compte.dossier.del": "Remove",
    "compte.dossier.view": "View",
    "compte.dossier.saved": "Document saved.",
    "compte.dossier.removed": "Document removed.",
    "compte.dossier.delConfirm": "Remove this document?",
    "cand.reuseNote": "Your saved documents will be attached automatically. Add or replace any below.",
    "cand.inFile": "✓ in your saved file",
    ...
    "lead.docs": "Documents (optional)",
    "lead.docsHint": "Speed up your case: title deed, current lease, plans, property tax… PDF/JPG/PNG/DOC, max 10 MB each.",
    "lead.docsAdd": "Add files",
    "lead.docsTooMany": "Up to 6 files.",
    "lead.docsTooBig": "Each file must be under 10 MB.",
    "lead.docsErr": "Some files couldn’t be uploaded. Please try again.",
    ...
    "cand.title": "Submit your application",
    "cand.sub": "Send your file in one go — complete applications are processed faster.",
    "cand.bien": "Property",
    "cand.docsLabel": "Application documents",
    "cand.docsNote": "One file per item · PDF/JPG/PNG/DOC, max 10 MB each.",
    "cand.doc.kbis": "Company registration (K-bis)",
    "cand.doc.bilans": "Latest balance sheets",
    "cand.doc.fiscal": "Tax & social clearance certificate",
    "cand.doc.assurance": "Insurance certificate (liability)",
    "cand.doc.identite": "Director’s ID",
    "cand.doc.rib": "Bank details (RIB)",
    "cand.doc.autre": "Other document",
    "cand.btn": "Send my application",
    "cand.note": "By sending, you agree to be contacted by Xeext about this property.",
    "cand.doneH": "Application received",
    "cand.doneP": "We’ve received your file. A Xeext advisor will get back to you very quickly.",
    "cand.toast": "Application sent.",
    "lead.ok": "OK",
  ...
  fr: {
    ...
    "compte.tab.dossier": "Mon dossier",
    "compte.tab.profil": "Profil",
    "compte.loading": "Chargement…",
    "compte.dossier.intro": "Enregistrez vos pièces une seule fois — elles seront jointes automatiquement à vos candidatures, sans avoir à les renvoyer.",
    "compte.dossier.add": "Ajouter",
    "compte.dossier.replace": "Remplacer",
    "compte.dossier.del": "Supprimer",
    "compte.dossier.view": "Voir",
    "compte.dossier.saved": "Document enregistré.",
    "compte.dossier.removed": "Document supprimé.",
    "compte.dossier.delConfirm": "Supprimer ce document ?",
    "cand.reuseNote": "Vos pièces enregistrées seront jointes automatiquement. Ajoutez ou remplacez ci-dessous si besoin.",
    "cand.inFile": "✓ dans votre dossier enregistré",
    ...
    "lead.docs": "Documents (facultatif)",
    "lead.docsHint": "Accélérez le traitement : titre de propriété, bail en cours, plans, taxe foncière… PDF/JPG/PNG/DOC, 10 Mo max par fichier.",
    "lead.docsAdd": "Ajouter des fichiers",
    "lead.docsTooMany": "6 fichiers maximum.",
    "lead.docsTooBig": "Chaque fichier doit faire moins de 10 Mo.",
    "lead.docsErr": "Certaines pièces n’ont pas pu être envoyées. Réessayez.",
    "lead.sending": "Envoi…",
    ...
    "cand.title": "Déposez votre dossier",
    "cand.sub": "Envoyez votre dossier en une fois — les dossiers complets sont traités plus vite.",
    "cand.bien": "Bien concerné",
    "cand.docsLabel": "Pièces du dossier",
    "cand.docsNote": "Un fichier par pièce · PDF/JPG/PNG/DOC, 10 Mo max par fichier.",
    "cand.doc.kbis": "Extrait K-bis",
    "cand.doc.bilans": "Derniers bilans",
    "cand.doc.fiscal": "Attestation de régularité fiscale & sociale",
    "cand.doc.assurance": "Attestation d'assurance (RC pro)",
    "cand.doc.identite": "Pièce d'identité du dirigeant",
    "cand.doc.rib": "RIB",
    "cand.doc.autre": "Autre document",
    "cand.btn": "Envoyer mon dossier",
    "cand.note": "En envoyant, vous acceptez d'être recontacté par Xeext à propos de ce bien.",
    "cand.doneH": "Dossier reçu",
    "cand.doneP": "Nous avons bien reçu votre dossier. Un conseiller Xeext revient vers vous très vite.",
    "cand.toast": "Dossier envoyé.",
    "lead.ok": "OK",
